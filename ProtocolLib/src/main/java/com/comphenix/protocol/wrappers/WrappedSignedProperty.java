...
public class WrappedSignedProperty extends AbstractWrapper {
	...
	/**
	 * Retrieve the signature of the property (base64) as returned by the
	 * session server's /hasJoined.
	 * 
	...
	/**
	 * Retrieve the value of the property (base64) as return by the session
	 * server's /hasJoined
	 * 
	...
	/**
	 * Determine if the signature of this property is valid and signed by the
	...
	public String toString() {
		return Objects.toStringHelper(this).add("name", getName()).add("value", getValue())
